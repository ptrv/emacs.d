...
;;;###autoload
(defun color-theme-cyberpunk-ptrv ()
  "Cyberpunk colour theme by Sam Aaron."
  (interactive)
  (color-theme-install
   '(color-theme-cyberpunk-ptrv
     ...
     (default ((t (:background "grey10" :foreground "light gray"))))
...
;;     (region ((t (:foreground "black" :background "#7F073F"))))
     ...
     (mode-line ((t (:background "gray20" :foreground "#4c83ff"))))
     (mode-line-inactive ((t (:background "gray20" :foreground "gray40"))))
     ...
     (popup-isearch-match ((t (:background "grey10" :foreground "deep pink"))))
     ...
     (naeu-green-face ((t (:foreground "green" :background "grey10"))))
     (naeu-pink-face ((t (:foreground "deep pink" :background "grey10"))))
     (naeu-blue-face ((t (:foreground "medium slate blue" :background "grey10"))))
     (naeu-orange-face ((t (:foreground "#FBDE2D" :background "grey10"))))
     (naeu-red-face ((t (:foreground "orange" :background "grey10"))))
     (naeu-grey-face ((t (:foreground "gray30" :background "grey10"))))

     (ido-first-match ((t (:foreground "deep pink" :background "grey10"))))
     (ido-only-match ((t (:foreground "deep pink" :background "grey10"))))
     (ido-subdir ((t (:foreground "gray60" :background "grey10"))))
     (ido-indicator ((t (:foreground "grey10" :background "deep pink"))))

     (match ((t (:foreground "deep pink" :background "blackn"))))
     (minibuffer-prompt ((t (:foreground "#61CE3C" :background "grey10"))))
